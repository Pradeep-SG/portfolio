  ...
  return (
    <div className="about">
      ...
      <div className="main-content">
        <div>
          <h3 data-aos="slide-down" className="heading">I am <span className="heading-span">Pradeep</span> S G</h3>
        </div>
        <div>
          <h4 data-aos="slide-down">A college student who is organized, collaborative, eager to learn, and has a year of valuable expertise in
